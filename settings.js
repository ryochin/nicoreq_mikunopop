...
settings["NotPTagsVO"] = ["", "MikuPOP", "RinPOP", "VochnoPop", "アニメOP", "ゲームOP", "エロゲOP", "偽OP", "J-POP", "これからもずっとbakerの嫁P", "2STEP", "ミーム第２期OP", "Human_Dump", "お前はもう死んでいるP", "吸引力の変わらない唯一の鼻そうめんP", "新人潰しを自称する割に全然潰せてないP", "忍者らじおOP", "Star_Step", ""];

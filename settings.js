...
settings["ItemHTML"] = "{#Type}{#Title}<br>"
	...
	+ "<b>ミ/</b>{#Count} <b>時/</b>{#Time} <b>計/</b>{#CTime}";
...
settings["InfoComment2"] = "■{#Date} 時/{#Time} ミ/{#Count} ◆再/{#View} コ/{#Comm} マ/{#List} ({#Myri}%)";

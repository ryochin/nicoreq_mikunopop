...
設定ファイルはsettings.jsです。いろいろ細かい設定ができるので、一度は見てみてください。
あとは、テスト用コミュなどを利用して、いろいろ遊んでみてください。

■メンテナンス

プログラムがあるフォルダにplaylog.txtとwatchlog.txtが自動生成されますが、
放っておくとかなりの容量になるのでたまにファイルごと消すといいかもしれません。
...
　　　settings.jsの４９行目付近「サムネイル画像表示」の項を参照してください。
　・ミクノ度をサーバに問い合わせないオプションを追加しました。
　　　settings.jsの５９行目付近「ミクノ度」の項を参照してください。
　・「ミ」は正式に「彡」に進化しました。
